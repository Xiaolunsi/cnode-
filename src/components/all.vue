<template>
	<div class="all">
		<!--<div ref="load" style="width: 35px;height: 40px;margin: 0 auto;"><mt-spinner type="snake"></mt-spinner></div>-->
		...
		<div class="con" v-for="sint in data">
			...
			<div class='con-bl' :class="sint.top==true?'green':'gray'">{{sint.top==true?'置顶':sint.good==true?'精华':sint.tab=='share'?'分享':sint.tab=='ask'?'问答':'招聘'}}</div>
		...
		<!--<div>
			<el-pagination layout="prev, pager, next" :total="1000" size-change="sizeChange"></el-pagination>
		</div>-->
